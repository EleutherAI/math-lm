...
#SBATCH --output=1.4b_48000_early_%x_%j.out      # Set this dir where you want slurm outs to go
#SBATCH --error=1.4b_48000_early_%x_%j.out      # Set this dir where you want slurm outs to go
...
python $TRAIN_PATH/deepy.py $TRAIN_PATH/train.py \
        --conf_dir /fsx/mathlm0/gpt-neox/configs/v0.4/ 1.4b-48000-early.yml
